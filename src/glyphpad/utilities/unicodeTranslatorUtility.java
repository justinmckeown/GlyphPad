...
import glyphpad.PredicateLogicPadController;

/**
 *
 * @author Justin McKeown
 */
public class unicodeTranslatorUtility extends PredicateLogicPadController{
    
    /*
    public static String returnSymbol(String newValue){
                ...
                //SET OF ALL NATURAL NUMBERS SYMBOL
                if(newValue.contains("\\Nat")){
                    replaceSymbol("\\Nat", "\u2115", cp);
                }
                //SET OF ALL INTEGER NUMBERS SYMBOL
                if(newValue.contains("\\Int")){
