...
public class HelpTextStore {
    ...
    public HelpTextStore(){
        ...
        setTheoryTextHelp.put("⊂ Proper subset '\\prop'", "Law 2.2.6: for any sets S and T, stating 'S is not properly included in S' is logically equivalent to the negation of the statement 'S is properly included in T'\n"
                + "𝑆 ⊄ 𝑇 ⟺ ¬(𝑆 ⊂ 𝑇) \n\n" 
